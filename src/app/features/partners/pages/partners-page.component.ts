...
@Component({
    ...
    <section class="page-hero">
      <div class="container" appScrollReveal="fade-up">
        ...
        <p class="page-hero__subtitle">
          ...
          expertise of our partner organisations, each bringing unique strengths to
          build Kenya's digital infrastructure talent pipeline.
        </p>
      </div>
    </section>
    ...
    <section class="partners-page">
      <div class="container">
        <div class="partners-page__list">
          @for (partner of partners; track partner.name; let i = $index) {
            <div
              class="partners-page__card"
            ...
            >
              <div class="partners-page__card-logo">
                <img
                  [src]="partner.logo"
                  [alt]="partner.alt"
                  class="partners-page__logo-img"
                  loading="lazy"
                />
              </div>
              <div class="partners-page__card-body">
                <div class="partners-page__card-type">
                  <span class="partners-page__type-badge">{{ partner.type }}</span>
                </div>
                <h2 class="partners-page__card-name">{{ partner.fullName }}</h2>
                <p class="partners-page__card-description">{{ partner.description }}</p>
                <div class="partners-page__card-focus">
                  <span class="partners-page__focus-label">Focus Areas</span>
                  <div class="partners-page__focus-tags">
                    @for (item of partner.focus; track item) {
                      <span class="partners-page__focus-tag">{{ item }}</span>
                    }
                  </div>
                </div>
                <a
                  ...
                  class="partners-page__card-link"
                >
                  Visit website
  ...
  styles: [`
    ...
    .partners-page__card:hover .partners-page__logo-img {
      filter: grayscale(0%);
    }

    .partners-page__card-body {
      padding: 32px 40px;
      display: flex;
      flex-direction: column;
      gap: 16px;
    ...
    .partners-page__card-description {
      font-family: var(--font-body);
      font-size: 0.9rem;
      line-height: 1.7;
    ...
    .partners-page__card-focus {
      display: flex;
      flex-direction: column;
      gap: 8px;
    }

    .partners-page__focus-label {
      font: var(--label-caps);
      font-size: 0.7rem;
      color: var(--color-on-surface-variant);
    ...
    .partners-page__focus-tags {
      display: flex;
      flex-wrap: wrap;
      gap: 6px;
    }

    .partners-page__focus-tag {
      font-size: 0.75rem;
      font-family: var(--font-body);
      font-weight: 500;
      color: var(--color-on-surface-variant);
