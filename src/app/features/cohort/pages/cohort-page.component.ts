      ...
      <section class="cohort-hero">
        ...
        <div class="container">
          <div class="cohort-hero__content">
            ...
            <p class="cohort-hero__subtitle">
              Fifteen talented young Kenyans selected from across the country, embarking on a 
              transformative journey to become certified digital infrastructure professionals.
            </p>
          </div>
        </div>
      </section>
            ...
            @for (trainee of trainees; track trainee.name; let i = $index) {
              <div class="cohort-grid__card" appScrollReveal="fade-up" [delay]="(i % 4) * 80">
                <div class="cohort-grid__card-portrait">
                  <span class="cohort-grid__card-avatar">{{ trainee.name.charAt(0) }}{{ trainee.name.split(' ')[1]?.charAt(0) }}</span>
                </div>
                <div class="cohort-grid__card-body">
                  <h3 class="cohort-grid__card-name">{{ trainee.name }}</h3>
                  <div class="cohort-grid__card-tags">
                    <span class="cohort-grid__card-tag cohort-grid__card-tag--county">{{ trainee.county }}</span>
                    <span class="cohort-grid__card-tag cohort-grid__card-tag--focus">{{ trainee.focus }}</span>
                  </div>
